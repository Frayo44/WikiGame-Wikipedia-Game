...
public class TextStep extends Step{
	...
	private InpValidator inpValidator;
	...
	protected TextStep(Builder builder){
		...
		inpValidator = builder.inpValidator;
	...
	public String check(){
		...
		return inpValidator.check(inputString);
	}
	...
	public static class InpValidator {
	...
	public static class Builder extends Step.Builder{
		...
		protected InpValidator inpValidator;
		...
		public InpValidator inpValidator() {
			return inpValidator;
		}
		public Builder inpValidator(InpValidator validator) {
			this.inpValidator = validator;
			return this;
		}
